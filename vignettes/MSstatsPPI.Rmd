...
statistical analysis results in the context of protein-protein interaction (PPI) 
networks. The package is designed to be used in conjunction with the `MSstats`.
